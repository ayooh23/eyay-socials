/** Default “About eyay” block appended as the closing section (matches proposal defaults). */
export const DEFAULT_DOC_EYAY_ABOUT = {
...
/** Studio lines on the doc cover (aligned with proposal defaults). */
export const DEFAULT_DOC_STUDIO_COVER = {
